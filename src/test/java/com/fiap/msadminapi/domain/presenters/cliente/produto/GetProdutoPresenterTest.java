...
public class GetProdutoPresenterTest {
    ...
    @Test
    void devePermitirRetornarOArrayCorretoQuandoImagemENula() {
        var uuid = UUID.randomUUID();
        var quantidade = 1;
        var categoria = CategoriaEnum.LANCHE;
        var valor = Float.parseFloat("17.9");
        var descricao = "";
        var nome = "Produto 1";
        var produto = new Produto(nome, valor, descricao, categoria, quantidade, null);
        produto.setUuid(uuid);
