...
public class ClienteConsumerTest {
    ...
    public void setUp() {
        ...
        clienteConsumer = new ClienteConsumer(kafkaConsumerProperties, clienteRepository);

        ReflectionTestUtils.setField(clienteConsumer, "consumer", kafkaConsumer);
    }
    ...
    public void testRunConsumer() throws Exception {
        ...
        String jsonMessage = "{\"cliente_id\":\"123e4567-e89b-12d3-a456-426614174001\",\"cliente_nome\":\"Cliente 1\",\"cliente_cpf\":\"12345678901\",\"cliente_email\":\"cliente1@email.com\"}";
        ...
        Thread consumerThread = new Thread(() -> {
            clienteConsumer.runConsumerCliente();
        });
