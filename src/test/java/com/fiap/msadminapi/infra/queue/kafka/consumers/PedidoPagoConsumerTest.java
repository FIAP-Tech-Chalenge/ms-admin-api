...
public class PedidoPagoConsumerTest {
    ...
    private PedidoPagoConsumer pedidoPagoConsumer;
    ...
    public void setUp() {
        ...
        pedidoPagoConsumer = new PedidoPagoConsumer(kafkaConsumerProperties, pedidoRepository, pedidoProdutoRepository);

        ReflectionTestUtils.setField(pedidoPagoConsumer, "consumer", kafkaConsumer);
    }
    ...
    public void testRunConsumer() throws Exception {
        ...
        when(pedidoRepository.findByUuid(UUID.fromString("123e4567-e89b-12d3-a456-426614174000")))
                .thenReturn(new PedidoModel());
        ...
        Thread consumerThread = new Thread(() -> {
            pedidoPagoConsumer.runConsumer();
        });
