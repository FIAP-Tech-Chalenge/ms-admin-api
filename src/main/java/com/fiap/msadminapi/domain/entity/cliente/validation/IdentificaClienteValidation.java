package com.fiap.msadminapi.domain.entity.cliente.validation;

import com.fiap.msadminapi.domain.entity.cliente.Cliente;
import com.fiap.msadminapi.domain.exception.cliente.EmailNaoPodeSerNuloException;
import com.fiap.msadminapi.domain.exception.cliente.NomeNaoPodeSerNuloException;
import com.fiap.msadminapi.domain.valuesObject.CpfValueObject;
